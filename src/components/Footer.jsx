...
const Footer = () => {
  return (
    <footer className=" p-8 w-full h-60 bg-black text-white flex-col justify-around items-center">
      <hr />
      ...
      <div className="container flex flex-col h-full justify-center items-center">
        ...
        <ul id="social-contacts" className="flex justify-center items-center gap-8 text-4xl">
          <li>
          <a href="#" target="_blank"><SlSocialInstagram className="hover:text-orange-300 cursor-pointer" /></a>

          </li>
          <li>
          <a href="#" target="_blank"><SlSocialLinkedin className="hover:text-orange-300 cursor-pointer" /></a>

          </li>
          <li>
          <a href="#" target="_blank"><SlSocialReddit className="hover:text-orange-300 cursor-pointer" /></a>

          </li>
          <li>
            <a href="#" target="_blank"><SlSocialFacebook className="hover:text-orange-300 cursor-pointer" /></a>
          </li>
        </ul>
      </div>
